...
<style>
.card{padding:1rem;background:#0f1624;color:#fff;border-radius:12px}
.lluvia{
  position:relative;
  height:240px;
  border-radius:12px;
...
/* Capa de gotas por debajo del título */
.rain-layer{
  position:absolute;
  inset:0;
  z-index:2;
...
@keyframes caer{ to{ top:calc(100% + 40px); } }
</style>
</head>
